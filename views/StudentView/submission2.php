                    ...
                    <div class="big-box">
                        <section id="region-main" class="content-col">
                            <div id="page-content">
                                ...
                                <h2 class="activity-name">Lab Assignment 1</h2>
                                    ...
                                    <div class="activity-description" id="intro">
                                        <div class="box py-3 generalbox boxaligncenter">
                                            <div class="no-overflow">
                                                <p>From the pdf file in labs named <a class="autolink" title="Lab 1" href="https://moodle1.miuegypt.edu.eg/mod/folder/view.php?id=1665">Lab 1</a> Pt2, write the python code for conversion to grayscale using:&nbsp;</p>
                                                <ol>
                                                    <li>Luminance (both methods provided)</li>
                                                    <li>Desaturation</li>
                                                    <li>Decomposition( max and min)</li>
                                                </ol>
                                                <p>Note: No ready made functions for the conversion are allowed.</p>
                                            </div>
                                            <div id="assign_files_tree655f8c6d537861">
                                                <div class="ygtvitem" id="ygtv0">
                                                    <div class="ygtvchildren" id="ygtvc0">
                                                        <div class="ygtvitem" id="ygtv1">
                                                            <table id="ygtvtableel1" border="0" cellpadding="0" cellspacing="0" class="ygtvtable ygtvdepth0 ygtv-expanded ygtv-highlight0">
                                                                <tbody>
                                                                    <tr class="ygtvrow">
                                                                        ...
                                                                        <td id="ygtvcontentel1" class="ygtvcell ygtvhtml ygtvcontent">
                                                                            <div>
                                                                                <div class="fileuploadsubmission"><img class="icon icon" alt="Fall23_CSC360_Lab 1 Pt. 2.pdf" title="Fall23_CSC360_Lab 1 Pt. 2.pdf" src="https://moodle1.miuegypt.edu.eg/theme/image.php/mb2nl/core/1698497336/f/pdf"> <a target="_blank" href="https://moodle1.miuegypt.edu.eg/pluginfile.php/11777/mod_assign/introattachment/0/Fall23_CSC360_Lab%201%20Pt.%202.pdf?forcedownload=1">Fall23_CSC360_Lab 1 Pt. 2.pdf</a> </div>
                                                                                <div class="fileuploadsubmissiontime">6 October 2023, 10:58 AM</div>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
